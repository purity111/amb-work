            ...
            <main>
                ...
                <div className="w-full max-w-[1200px] m-auto text-white px-4 lg:px-0 md:mb-25">
                    <div className="md:text-left md:mr-8 xl:mr-20">
                        ...
                        <h1 className="text-[26px] md:text-[35px] lg:text-[44px] font-semibold text-black mb-2">未経験者サポート</h1>
                        <p className="text-[14px] md:text-[18px] text-gray-300 font-semibold">Inexperienced Support</p>
                    </div>
                </div>
                ...
                <div className="w-full my-10 sm:my-[50px] md:my-0 md:w-1/2 relative bg-white h-[160px] sm:h-[250px] md:h-[350px] flex justify-end rounded-tl-[50px] sm:rounded-tl-[80px] md:rounded-tl-[100px] overflow-hidden md:absolute md:right-0 md:top-[180px]">
                    <Image
                        src="/images/inexperience/top.jpg"
                        alt="資格バナー"
                        fill
                ...
                <div className="py-12 relative experience px-4 md:px-0">
                    ...
                    <span className="flex font-bold max-w-fit justify-center py-1 px-2 m-auto mt-3 bg-[#65B729] text-[18px] md:text-[25px] text-white">13年連続成長している</span>
                ...
                <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8 md:gap-12 mb-12 px-[5%]">
                    <div className="w-full md:w-[340px] lg:w-[430px] xl:w-[550px] flex-shrink-0 flex justify-center">
                        <Image
                            src="/images/inexperience/nayami.jpg"
                            alt="悩む人"
                            width={340}
                            height={260}
                    ...
                    <div className="w-full md:flex-1">
                        <CheckList
                            items={INEXPERIENCE_NAYAMI_ITEMS}
                        />
                    </div>
                </div>
                ...
                <div className="bg-[#ffffde] rounded-md my-12 p-6 md:p-12 w-[90%] sm:w-[80%] lg:max-w-[960px] mx-auto relative">
                    ...
                    <div className="aspect-[10/13] w-[96px] absolute bottom-[-80px] md:bottom-[-30px] right-0">
                        <Image
                            src='/images/inexperience/illust.png'
                            alt="シンプルイラスト"
                            fill
                ...
                <section className="relative mt-30 py-16 md:py-24 bg-cover bg-center" style={{ backgroundImage: 'url(/images/inexperience/bg.jpg)' }}>
                ...
                <div className="bg-gray-800 rounded-tl-[100px] md:rounded-tl-[200px] mt-20">
                    ...
                    <section className="py-6">
                        <div className="max-w-[1200px] md:m-auto mx-3 flex flex-col md:flex-row justify-center gap-15 md:gap-10">
                            {INEXPERIENCE_SUCCESS_CASES.map((props, idx) => (
                    ...
                    <span className="flex font-bold max-w-fit justify-center py-1 px-2 m-auto mt-20 bg-[#65B729] text-[18px] md:text-[25px] text-white">13年連続成長している</span>
                    <h2 className="text-[20px] md:text-[28px] font-bold text-center pb-10">
                        リユース、リサイクル、買取業界で<br />
