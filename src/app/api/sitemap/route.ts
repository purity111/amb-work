...
export async function GET() {
  try {
    ...
    const staticPages = [
      ...
      { path: '/business-new', priority: '0.7', changefreq: 'monthly' },
      { path: '/career-counseling', priority: '0.7', changefreq: 'monthly' },
      { path: '/company', priority: '0.7', changefreq: 'monthly' },
      { path: '/contact', priority: '0.6', changefreq: 'monthly' },
      { path: '/experience', priority: '0.7', changefreq: 'monthly' },
      { path: '/inexperience', priority: '0.7', changefreq: 'monthly' },
      { path: '/interview', priority: '0.7', changefreq: 'monthly' },
      { path: '/job-openings', priority: '0.8', changefreq: 'daily' },
      { path: '/mid-high', priority: '0.7', changefreq: 'monthly' },
      { path: '/qualifications', priority: '0.7', changefreq: 'monthly' },
      { path: '/recruiter', priority: '0.7', changefreq: 'monthly' },
