...
export default function RecruiterFinishPage() {
  return (
    <>
      <main className="bg-white">
        ...
        <div className="w-full max-w-[1200px] m-auto text-white px-4 lg:px-0 md:mb-25">
          <div className="md:text-left md:mr-8 xl:mr-20">
            ...
            <h1 className="text-[26px] md:text-[35px] lg:text-[44px] font-bold text-black mb-2">採用担当者様お問い合わせ完了</h1>
            <p className="text-[14px] md:text-[18px] text-gray-300 font-bold">Recruiter Contact Complete</p>
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600 mb-8">
               ...
               <h3 className="text-lg font-semibold mb-4">採用担当者様向けサービスについて</h3>
               <p className="text-gray-600 mb-4">
                 ご入力いただいた内容は、リユース転職運営事務局で確認いたします。
                 採用に関するご相談やサービスについて、専門の担当者が詳しくご説明いたします。
               </p>
               <p className="text-gray-600">
                 通常、2営業日以内にご連絡いたしますが、内容によってはお時間をいただく場合がございます。
               </p>
             </div>
